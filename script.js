...
<nav class="hyper-nav">
  ...
  <div class="hyper-nav__active-indicator"></div>
</nav>
...
document.getElementById("check-btn").addEventListener("click", function () {
    ...
    const selectedIndicator = document.querySelector('.indicator-text-item.active').dataset.indicator;
